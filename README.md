...
[![artefacts_ci](https://app.artefacts.com/api/artefacts/navigation2-ignition-example/badges/nav2-goal.png?branch=main)](https://app.artefacts.com/artefacts/navigation2-ignition-example)
